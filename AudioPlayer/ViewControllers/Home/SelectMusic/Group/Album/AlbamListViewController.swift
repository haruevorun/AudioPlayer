...
class AlbumListViewController: BaseListViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.tableView.register(UINib(nibName: "AlbamListTableViewCell", bundle: nil), forCellReuseIdentifier: "List")
...
extension AlbumListViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "List", for: indexPath) as? AlbamListTableViewCell else {
            fatalError()
        }
